...
<body>
  ...
  <h2>Dashboard</h2>
  <hr>
  <p>Platform for Cashiers to Evaluate Dataflow.</p>
  <?php
        $test=0;
        $sum=0;
  ...
  <center>
    <table>
    	<tr>
	    <td><div class="card">
		  <img src="../../img/expenditure.png" alt="Total sales" style="width:100%">
		  <h1>Total sales</h1>
		  <p class="price">No.&nbsp<?php echo $test; ?></p>
		  <p>ID.&nbsp<?php echo $test_run1; ?></p>
		  <p><button><?php echo $sum; ?></button></p>
		</div></td>
    <?php
          $profit=0;
          $profitsum=0;
    ...
    ?>
		<td><div class="card">
		  ...
		  <h1>Profit</h1>
		  <p class="price">ID.&nbsp<?php echo $test_run1; ?></p>
		  <p>Expanditure.&nbsp<?php echo $profitsum; ?></p>
		  <p><button><?php echo $profit; ?></button></p>
		</div></td>
		</tr>
	</table>
	</center>
