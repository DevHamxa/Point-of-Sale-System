...
<body>
  ...
  <h2>Dashboard</h2>
  <hr>
  <p>Platform for Stock Manager to Evaluate Dataflow.</p>
  <?php
          $run=0;
          $profitsum=0;
          $test_run1 = $num_row['SM_ID'];
  ...
  <center>
    <div class="card">
		  <img src="../../img/expenditure.png" alt="Expanditure" style="width:100%">
		  <h1>Expanditure</h1>
		  <p class="price">$ID.&nbsp<?php echo $test_run1; ?></p>
		  <p>Expense.&nbsp<?php echo $profitsum; ?></p>
		  <p><button>Recived Items.&nbsp<?php echo $run; ?></button></p>
		</div>
	</center>
  </div>
