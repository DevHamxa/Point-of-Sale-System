...
<body>
  ...
  <div class="w3-sidebar w3-bar-block w3-black large" style="width:180px">
    ...
    <div class="w3-container" style="margin-left:180px">
        <hr>
        <h2><b>Hi!&nbsp</b><?php echo $num_row['AD_F_Name']; ?></h2>
        <hr>
        <p>Platform for Admins to Change there ID Information.</p>
        <div class="card">
        <img src="../img/img_avatar.png" alt="Admin Pic" style="width:100%">
        <h1><?php echo $num_row['AD_F_Name'] . " " . $num_row['AD_L_Name']; ?></h1>
        <p class="title"><?php echo $num_row['AD_Email']; ?></p>
        <p><?php echo $num_row['AD_Contact']; ?></p>
